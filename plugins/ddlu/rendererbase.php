 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_ddlu_renderer_base extends qtype_with_combined_feedback_renderer {
    ...
    public function formulation_and_controls(question_attempt $qa,
        ...
        $this->page->requires->string_for_js('blank', 'qtype_ddlu');
        $this->page->requires->js_call_amd('qtype_ddlu/question', 'init',
